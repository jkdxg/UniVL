...
class MSRVTT_Caption_DataLoader_Swin(Dataset):
    ...
    def __init__(
        ...
        if split_type == "train":  # expand all sentence to train
            ...
            for vid in choiced_video_ids:
                self.sentences_dict[len(self.sentences_dict)] = (vid, self.video_sentences_dict[vid][0]) # 虽然一个视频有20句caption，但是在test的时候只取了每个视频的第一句
        else:
    ...
    def __getitem__(self, idx):
        ...
        if self.split_type =='test':
            video_file = '/home/gujiayang/data/dataset/videocaption/msrvtt_swin/TestVideo/' + video_id+'.mp4'
        else:
            video_file = '/home/gujiayang/data/dataset/videocaption/msrvtt_swin/videos/' + video_id+'.mp4'
        ...
        return pairs_text, pairs_mask, pairs_segment, images, video_mask, \
