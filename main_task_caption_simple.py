...
def prep_optimizer(args, model, num_train_optimization_steps, device, n_gpu, local_rank, coef_lr=1.):
    ...
    decay_swin_trsfr_param_tp = [(n, p) for n, p in decay_nobert_param_tp if  "swin." in n  or "trsfr." in n]
    no_decay_swin_trsfr_param_tp = [(n, p) for n, p in no_decay_nobert_param_tp if  "swin." in n or "trsfr." in n]
    
    no_decay_nobert_param_tp_1 = [(n, p) for n, p in no_decay_param_tp if "bert." not in n and "swin." not in n and "trsfr." not in n]
    decay_nobert_param_tp_1 = [(n, p) for n, p in decay_param_tp if "bert." not in n and "swin." not in n and "trsfr." not in n]
    optimizer_grouped_parameters = [
        ...
        {'params': [p for n, p in decay_swin_trsfr_param_tp], 'weight_decay': 1e-3,'lr':1.2e-5},
        {'params': [p for n, p in no_decay_swin_trsfr_param_tp], 'weight_decay': 1e-3,'lr':1.2e-5}
